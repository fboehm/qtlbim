...
\end{Sinput}
\end{Schunk}
<<results='asis',echo=FALSE,label=bestplot>>=
...
\end{Sinput}
\end{Schunk}
<<results='asis',echo=FALSE,label=besthcplot>>=
...
\end{Sinput}
\end{Schunk}
<<results='asis',echo=FALSE,label=closeplot>>=
...
\end{Sinput}
\end{Schunk}
<<results='asis',echo=FALSE,label=closenqtlplot>>=
...
\end{Sinput}
\end{Schunk}
<<results='asis',echo=FALSE,label=multplot>>=
...
\end{Sinput}
\end{Schunk}
<<results='asis',echo=FALSE,label=multmergeplot>>=
...
\end{Sinput}
\end{Schunk}
<<results='asis',echo=FALSE,label=oneplot>>=
