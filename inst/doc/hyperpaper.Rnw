% \VignetteIndexEntry{qtlbim freeze notes}
...
if(.qb.Package) { ## Called by Sweave directly or in R build.
  ...
  .qb.SweaveExtra <- system.file("external", "hyperpaperextra.Rnw", package="qtlbim")
